...
public class CyclicBarrierSingle {
	...
	public static void main(String args[]) {
		...
		/*
		 * public CyclicBarrier(int parties,Runnable barrierAction) Creates a
		 * new CyclicBarrier that will trip when the given number of parties
		 * (threads) are waiting upon it, and which will execute the merger task
		 * when the barrier is tripped, performed by the last thread entering
		 * the barrier.
		 */
