...
public class READ_UNCOMMITTED_Example {
	...
	public static void main(String[] args) {
		...
		Thread thread1 = new Thread(new Runnable() {
			public void run() {
				try {
					bookShop.setStock4Isolation(1, 10);
		...
		Thread thread2 = new Thread(new Runnable() {
			public void run() {
				bookShop.getStockCount4Isolation_READ_UNCOMMITTED(1);
				System.out.println("[Thread 2] End - final count : " + bookShop.getStockCount(1));
			}
		}, "Thread 2");
